...
public class <%ServiceName%>ProxyInterface implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        Object obj = dispatchToNative(method.getName(), NativeDispatchHelper.getMethodSignature(method.getReturnType(), method.getParameterTypes()), args, pointer);
        cleanNative(pointer);
        return obj;
    }

    public native Object dispatchToNative(String methodName, String methodSig, Object[] args, long pointer);
